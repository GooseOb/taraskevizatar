...
' $1аў ':/ (абрэвіятур|войск|гадзін|гор|дзяўчат|жанчын|камэр|кас|краін|крам|літар|малекул|марфем|мініятур|мужчын|налад|паводзін|плянэт|плятформ|пэрсон|рыс|рэклям|сіл|служб|сфэр|сыстэм|тэмпэратур|тэм|улад|хвілін|цыгар(?:эт)?|эстафэт) /,
