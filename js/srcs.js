...
'цыліндар ':/цыліндр /,
'(ы)(ую) (цынамон)(карыцу)':/ую карыцу/,
	'(ы)(ая) (цынамон)(карыца)':/ая карыца/,
	'(ым)(ім)(ай) (цынамонам)(карыцай)':/ай карыцай/,
	'(ага)(аму)(ай) (цынамону)(карыцы)':/ай карыцы/,
	'(цынамон)($1)':/(карыц[ау])/,
	'(цынамонам)(карыцай)':/карыцай/,
	'(цынамону)(карыцы)':/карыцы/,
	'(цынамонаў)(карыц)':/карыц/,
...
/* а + ні */
' (ан)(н)і$1 ':/ ні(хто|чога|што) /,
' (аніко)(нік$1)$2 ':/ нік(а|о)(га|му) /,
/* г > ґ */
' аґр$1 ':/ агр([ауы]|ай) /,
' ґа$1 ':/ га(ем?|й|ю|я) /,
' ґан$1к':/ ган(а?)к/,
...
' $1аў ':/ (абрэвіятур|войск|гадзін|гор|дзяўчат|жанчын|камэр|кас|краін|крам|літар|малекул|марфем|мініятур|мужчын|налад|паводзін|плянэт|плятформ|пэрсон|рэклям|сіл|служб|сфэр|сыстэм|тэмпэратур|тэм|улад|хвілін|цыгар(?:эт)?|эстафэт) /,
