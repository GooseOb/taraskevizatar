...
'$1(ліюс)(ліяў) ':/(ю|карне)лій /,
	...
	' люцы':/ луцы/,
/* іра, іро */
'$<ir>$2':/(?<ir>абстраг|акліматыз|(?:а|нацыя)наліз|баланс|ваеніз|груп|імпан|імправіз|інфарм|іраніз|каляніз|каляпс|каталіз|культыв|курс|нэрв|плян|прагназ|прыватыз|рэаг|санкцыян|тыпіз|урбаніз|фантаз|фар[мс]|фінанс|фраз|функцыян)ір(а|у)/,
...
/* а > у */
'$<au>у ':/(?<au>[іы]зм|завод|інстытут|канал|абед|менск|полацк)а /,
/* Летувіскія назвы */
...
' $1ыяў ':/ (імпэр|стыпэнд|сымпат|с[ыэ]р|сымэтр)ый /,
' $1іяў ':/ (ліб|мітрапол|прафэс|пэрс|сылез|сымфон|сыцыл|сэс|трансыльван|флятыл)ій /,
' $1аў ':/ (абрэвіятур|войск|гадзін|гор|жанчын|камэр|кас|краін|крам|літар|малекул|марфем|мініятур|мужчын|налад|паводзін|плянэт|плятформ|пэрсон|рэклям|сіл|служб|сфэр|сыстэм|тэмпэратур|тэм|улад|хвілін|цыгар(?:эт)?|эстафэт) /,
