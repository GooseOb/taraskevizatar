...
let els3 = 'г[еа]л|бэрыл|тул|бэркл|набэл';
...
'камэнд':'каменд',
'камэнт':'камент',
	'$1мэнтар':'(ка|парля)мэнтарый',
	'$1мэнтары':'(ка|парля)мэнтарыі',
	'$1мэнтара ':'(ка|парля)мэнтарыя ',
	'$1мэнтароў':'(ка|парля)мэнтарыяў',
'камэр':'камер',
'кампазы':'кампазі',
'кампанэн':'кампанен',
'кампут':'камп’ют',
...
'люнэбур':'люнебур',
' люўр':' луўр',
' $1ля$2$3':' ((пра|не)?)ла(б|г)(аван|і|уе)',
'лябара$1':'лабара(н|т)',
'ляванд':'лаванд',
'ляга$1':'лага(тып|рыф)',
'лягуна':'лагуна',
...
'марэлев':'абрыкосав',
	...
	'ай марэлі ':'[іы]м абрыкосе ',
	'ай марэльлю ':'[іы]м абрыкосам ',
	'марэлі ':'абрыкос[аеы] ',
	'марэльлю ':'абрыкосам ',
	'марэ(ля)(лю) ':'абрыкос ',
	'марэляў':'абрыкосаў',
...
'мінэрал':'мінерал',
'менск':'мінск',
'(ае)($1) (места)(горад) ':'(і|ы) горад ',
	' (места)(горад) ':' горад ',
	' (мест)(горад)$1':' горад(а|у)',
	' (месьц)(горадз)е ':' горадзе ',
	' (местаў)(гарадоў) ':' гарадоў ',
	' (мест)(гарад)':' гарад',
'міт':'міф',
...
'пляшк':'плашк',
'плютон':'плутон',
'$1ая плоць ':'(\\S{3})[ыі] пол ',
	'$1ай плоцьцю ':'(\\S{3})[ыі]м полам ',
	'$1ай плоці ':'(\\S{3})а(га|му) пол[ау] ',
	' плоць ':' пол ',
	' плоцьцю ':' полам ',
	' плоці ':' пол[ау] ',
	' плоцев':' палав([ауы])',
...
'цыліндар ':'цыліндр ',
'ы цынамон':'ая карыца|ую карыцу',
	'(ы)(і)м цынамонам':'ай карыцай',
	'а(га)(му) цынамону':'ай карыцы',
	'ых цынамонаў':'ых карыц',
	'цынамон':'карыц[ау]',
	'цынамонам':'карыцай',
	'цынамону':'карыцы',
	'цынамонаў':'карыц',
'ая $1ля ':'ая (цэ|ро|альвэо|вакуо|жырандо)ль ',
	'ую $1лю ':'ую (цэ|ро|альвэо|вакуо|жырандо)ль ',
	' $1(ля)(лю) ':' (цэ|ро|альвэо|вакуо|жырандо)ль ',
	' $1ляй ':' (цэ|ро|альвэо|вакуо|жырандо)ллю ',
...
'танталем':'танталам',
	...
	'танталю':'танталу',
	'тантал':'танталь',
'плятын':'плацін', //могуць быць праблемы з плацінамі
...
'$1(ліюс)(ліяў) ':'(ю|карне)лій ',
	...
	' люцы':' луцы',
/* іра, іро */
'$<ir>$2':'(?<ir>абстраг|акліматыз|(?:а|нацыя)наліз|баланс|ваеніз|груп|імпан|імправіз|інфарм|іраніз|каляніз|каляпс|каталіз|культыв|нэрв|плян|прагназ|прыватыз|рэаг|санкцыян|тыпіз|урбаніз|фантаз|фар[мс]|фінанс|фраз|функцыян)ір(а|у)',
...
'$<ir>ля':'(?<ir>дуб|кантрал|капітул|прафі|пэда)ліра',
'$<ir>лю':'(?<ir>дуб|кантрал|капітул|прафі|пэда)ліру',

'$<ir>я':'(?<ir>канстру|тату)іра',
'$<ir>ю':'(?<ir>канстру|тату)іру',
/* ей > яў */
'$1яў ':'(каніфол|кішэн|прымес|пэдал|ростан|сенажац|скрон|сувяз|тунэл|туфл|цюл|шампун)ей ',
'ценяў ':'цяней ',
'сьцяў ':'сцей ',
' $1асьцей ':' (г|к|(?:най)?ч)асьцяў ',
/* а > у */
'$<au>у ':`(?<au>[іы]зм
завод
інстытут
...
' ндр ':' гдр ',
' фрн ':' фрг ',
/* Іншыя 2 */ // ёсьць праблема зь некалькімі мяккімі знакамі
' ня $1':` не ((вы)?(брал[аі]
буд(зе|у(ць|чы)?)
ваш
...
/* ах > ох */
'$1(о)(а)х ':'(бацьк|бераг|брат|вач|вуш|гарад|даждж|дзьвяр|канц|ляс|нач|пляч|пяск|раз|сад|склад|стал|сябр|хвальк|хляв)ах ',
'$1(ё)(я)х ':'(агн|вучн|грудз|касьц|пал)ях ',
'в(ало)(ола)х ':'волах ',
'в(ачо)(оча)х ':'вочах ',
'жл(або)(оба)х ':'жл[ао]б ',
'м(алато)(олата)х ':'молатах ',
'р(адо)(ода)х ':'родах ',
/* г > ґ */
' аґр$1 ':' агр([ауы]|ай) ',
' ґа$1 ':' га(ем?|й|ю|я) ',
...
'ць$1':'ц([влмнпсф][еёіюяь])',
'$1ь $2$3':`( (?:б[ея]|пра|цера)?з) (\\(?)([еёюяь]|([бвзйлмнпстфц]|дз)[еёіюяь]|імі? |іхні|${iwords})`,
'$1ь$2':'(с|з)’([яюеё])',
};
...
' \u0627$1':' ([аеэыуо])', // першая галосная, аліф
'ࢮ$1':'д\u0652з'+soft,
'ز$1':'з'+soft,
'ك$1':'к'+soft,
'ث$1':'с'+soft,
