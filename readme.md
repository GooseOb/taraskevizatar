...
<br>Увага! Нельга, каб першая літара зьмяняльнай часьціны была адною з наступных літар: е ё і ь ю я;
<br>Напрыклад: `зям(ля)(лю)`,`зьм(яя)(яю)` - слушна, `зямл(я)(ю)`, `зьмя(я)(ю)` - не;
