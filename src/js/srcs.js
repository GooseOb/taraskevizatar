...
const els3 = ' гал|гел|бэрыл|тул|бэркл|набэл';
...
'$1е':`(${els3})іі`,
/* ер > эр */
'$1эр':/(антрэпрэн|бакс|грав|грым|гіпнатыз|паз|плян|прыз|рэжыс|рэзан|сап|сутэн|трас|фантаз)ёр/,
...
'$1аваньне': /(бляк|балянс|інсцэн|маск|плян|трэн)іроўка/,
'$1аваньня': /(бляк|балянс|інсцэн|маск|плян|трэн)іроўкі/,
'$1аваньні': /(бляк|балянс|інсцэн|маск|плян|трэн)іроўцы/,
'$1аваньню': /(бляк|балянс|інсцэн|маск|плян|трэн)іроўцэ/,
'$1аваньнем':/(бляк|балянс|інсцэн|маск|плян|трэн)іроўкай/,
...
'фармаваньне': /фарміроўка/,
'фармаваньня': /фарміроўкі/,
'фармаваньні': /фарміроўцы/,
'фармаваньню': /фарміроўцэ/,
'фармаваньнем':/фарміроўкай/,
...
while (gwords.length) {
	const gword = gwords.pop();
	wordlist[gword] = RegExp(gword.replace(/ґ/g, 'г'), 'g');
};
}