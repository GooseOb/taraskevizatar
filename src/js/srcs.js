...
' $1аў ':/ (абрэвіятур|асоб|войск|гадзін|гор|дзяўчат|жанчын|змен|камэр|кас|краін|крам|літар|малекул|марфем|мініятур|мужчын|мясьцін|налад|паводзін|плянэт|плятформ|правіл|пэрсон|ракет|рыс|рэклям|сіл|служб|сфэр|сыстэм|тэмпэратур|тэм|улад|хвілін|цыгар(?:эт)?|эстафэт) /,
