...
' пяшч':/ пясч/,
/* Поўныя формы */
' $1ц(ый)(ыяў) ':/ (апэра|кампазы|кампіля|кампэнса|кантрыбу|канфэрэн|карэля|каўза|на|пазы|прэфэрэн|рэкамэнда|(?:рэпа)?ра|сымуля|сытуа|трады|трапэ|экспэды|эксплюата)цый /,
' $1(ый)(ыяў) ':/ (акц|імпэр|стыпэнд|сымпат|с[ыэ]р|сымэтр)ый /,
' $1(ій)(іяў) ':/ (ліб|мітрапол|прафэс|пэрс|сылез|сымфон|сыцыл|сэс|трансыльван|флятыл)ій /,
